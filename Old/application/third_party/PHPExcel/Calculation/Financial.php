...
class PHPExcel_Calculation_Financial
{
     ...
     * @param  integer $basis The type of day count:                                         0 or omitted US (NASD)    360                                         1                        Actual (365 or 366 in a leap year)                                         2                        360                                         3                        365                                         4                        European 360
     * @return integer
     */
     ...
     * @param    integer $frequency     the number of coupon payments per year.                                                                                      1    Annual                                             2    Semi-Annual                                             4    Quarterly                                                                                                                               6    Bimonthly                                             12    Monthly
     * @param    integer $basis         The type of day count to use.                                             0 or omitted    US (NASD) 30/360                                             1                Actual/actual                                             2                Actual/360                                             3                Actual/365                                             4                European 30/360
     * @return   float
     */
     ...
     * @param    integer $type  A number 0 or 1 and indicates when payments are due:                                     0 or omitted    At the end of the period.                                     1                At the beginning of the period.
     * @return   float
     */
