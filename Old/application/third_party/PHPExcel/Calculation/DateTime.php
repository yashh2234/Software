...
class PHPExcel_Calculation_DateTime
{
     ...
     * @param    mixed   $startDate Excel date serial value (float), PHP date timestamp (integer),                                         
     * @param    mixed   $endDate   Excel date serial value (float), PHP date timestamp (integer),                                         
     * @param    integer $method    Method used for the calculation                                             0 or omitted    US (NASD) 30/360                                             1                Actual/actual                                             2                Actual/360                                             3                Actual/365                                             4                European 30/360
     ...
     *
     * @param  mixed $dateValue Excel date serial value (float), PHP date timestamp (integer),                                         
     * @param  int   $style     A number that determines the type of return value                                             1 or omitted    Numbers 1 (Sunday) through 7 (Saturday).                                             2                Numbers 1 (Monday) through 7 (Sunday).                                             3                Numbers 0 (Monday) through 6 (Sunday).
     ...
     *
     * @param  mixed   $dateValue Excel date serial value (float), PHP date timestamp (integer),                                         
     * @param  boolean $method    Week begins on Sunday or Monday                                             1 or omitted    Week begins on Sunday.                                             2                Week begins on Monday.
