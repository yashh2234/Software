      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <button class="btn btn-primary" onclick="sendallmessage();">Send All</button>
          </div>
...
$(document).ready(function() {
    ...
    manageTable = $('#manageTable').DataTable
        ({
            'ajax': 'fetchbillingduebalanceData',
            "pageLength": 50,
            scrollX: true,
            'order': []
        });
...
function sendmessage(id)
{
    if(id) 
    { 
       if (confirm("Are you sure want to send reminder Message?")) 
        {
