...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Create Performa Invoice</li>
    </ol>
  </section>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Create Performa Invoice</h3>
            </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('invoice/create') ?>" method="post" class="form-horizontal" id="formsubmitn">
              <div class="box-body">
                ...
                <div class="row formsection">
                    ...
                    <div class="col-xs-6" style="margin: 5px 0px;">
                      ...
                      <div class="col-xs-8">
                          <input type="text" class="form-control" id="work_order_no" name="work_order_no" placeholder="Enter Purchase Order" /> 
                       </div>
                    </div>
                    <div class="col-xs-6" style="margin: 5px 0px;">
                      <div class="col-xs-4">
                      ...
                      <div class="col-xs-8">
                          <input type="date" class="form-control" id="work_order_date" name="work_order_date" placeholder="Enter Purchase Date" /> 
                       </div>
                    </div>
                    <div class="col-xs-6" style="margin: 5px 0px;">
                      <div class="col-xs-4">
                      ...
                      <div class="col-xs-8">
                          <input type="text" class="form-control" id="report_no" name="report_no" placeholder="Enter Report No" /> 
                       </div>
                    </div>
                    <div class="col-xs-6" style="margin: 5px 0px;">
                      <div class="col-xs-4">
                      ...
                      <div class="col-xs-8">
                          <input type="date" class="form-control" id="report_date" name="report_date" placeholder="Enter Report Date" /> 
                       </div>
                    </div>
                    ...
                    <div class="col-xs-6" style="margin: 5px 0px;">
                      ...
                      <div class="col-xs-8">
                          <input type="text" class="form-control" id="agency_gst" name="agency_gst" placeholder="Enter Agency Gst Number" /> 
                       </div>
                    </div>
                    <div class="col-xs-6" style="margin: 5px 0px;">
                      <div class="col-xs-4">
                    ...
                    <div class="col-xs-6" style="margin: 5px 0px;">
                      ...
                      <div class="col-xs-8">
                          <input type="text" class="form-control" id="terms_of_delivery" name="terms_of_delivery" placeholder="Enter Terms Of Delivery" /> 
                       </div>
                    </div>
                    <div class="col-xs-6" style="margin: 5px 0px;">
                        <div class="col-xs-4" >
                    ...
                    <div class="col-xs-6" style="margin: 5px 0px;">
                      ...
                      <div class="col-xs-8">
                          <input type="text" class="form-control" id="sgst_amount" name="sgst_amount" placeholder="Total State Gst Amount" onkeyup="calculate_gst();" /> 
                       </div>
                    </div> 
                    <div class="col-xs-6" style="margin: 5px 0px;"></div>
                    <div class="col-xs-6" style="margin: 5px 0px;">
                      ...
                      <div class="col-xs-8">
                          <input type="text" class="form-control" id="cgst_amount" name="cgst_amount" placeholder="Total Gst Amount" onkeyup="calculate_gst();" /> 
                       </div>
                    </div> 
                    <div class="col-xs-6" style="margin: 5px 0px;"></div>
                    <div class="col-xs-6" style="margin: 5px 0px;">
