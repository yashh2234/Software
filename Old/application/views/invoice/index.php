    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createBilling', $user_permission)): ?>
          <a href="<?php echo base_url('invoice/create') ?>" class="btn btn-primary">Create Invoice</a>
        <?php endif; ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Remove Invoice</h4>
      </div>

      <form role="form" action="<?php echo base_url('invoice/remove') ?>" method="post" id="removeForm">
...
$(document).ready(function() 
{
  ...
  $("#manageOrdersNav").addClass('active');
    ...
    if(start_date)
    {
        ...
        'ajax': base_url + 'invoice/fetchinvoiceFilterData?start_date='+start_date+'&end_date='+end_date, 
        'order': []
    ...
    else
    {
         // initialize the datatable 
        manageTable = $('#manageTable').DataTable({
        'ajax': base_url + 'invoice/fetchinvoicesData', 
        'order': []
        });
