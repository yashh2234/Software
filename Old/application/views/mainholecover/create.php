...
<div class="row uidsection">
                ...
                <div class="row formsection" style="display:none;">
			      ...
			      <div class="row formsection" style="display:none;">
                        ...
                        <h5 style="padding:8px;border:1px solid #000;color:#000;text-transform: uppercase;text-align:center;">TEST RESULTS (As per IS : 12592-2002,Manhole Cover)</h5>
                       </div>
                    </div>
			        <div class="row formsection" style="display:none;">
    			        ...
    			        <tr>
    			            <td colspan ="8">
    			                <select class="form-control" id="hole_type" name="hole_type">
    			                    <option value="Main Hole Ring & Cover (HD 20)">Main Hole Ring & Cover (HD 20)</option>
    			                    <option value="Main Hole Ring & Cover (LD 25)">Main Hole Ring & Cover (LD 25)</option>
    			                    <option value="Main Hole Ring & Cover (MD 10)">Main Hole Ring & Cover (MD 10)</option>
    			                    <option value="Main Hole Ring & Cover (EHD 35)">Main Hole Ring & Cover (EHD 35)</option>
    			                </select>
    			            </td>
    			        </tr>
    			        <tr>
                                ...
                                <td><input type="text" class="form-control" id="dia_of_plat" name="dia_of_plat" placeholder="Dia of Plat"/></td>
                                <td><input type="text" class="form-control" id="date_of_sample_collection" name="date_of_sample_collection" placeholder="Date Of Sample Collection" /></td>
                                <td><input type="text" class="form-control" id="date_of_testing" name="date_of_testing" placeholder="Date Of Testing" /></td>
                                <td><input type="text" class="form-control" id="applying_of_load" name="applying_of_load" placeholder="Applying of Load" /></td>
                                <td>
        			            ...
        			            <td> <input type="text" class="form-control" id="remark" name="remark" placeholder="Enter Remark" /></td>
        			        </tr>
        			       <input type="hidden" value="1" id="countset" name="countset">
    			        </tbody>
						</table>
			        </div>
