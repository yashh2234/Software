...
<div class="content-wrapper">
  ...
  <?php if(!empty($order_data['order'][0]['ulr_no'])){?>
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('water/update') ?>" method="post" class="form-horizontal" id="formsubmitn">
              <div class="box-body">
...
<div class="row">
  ...
  <table class="table table-striped">
                        ...
                        <input type="hidden" value="<?php echo $rowcount;?>" id="countset" name="countset"> 
                                ...
                                <tr>
            			            <td><?=$i;?></td>
            			            <td><input type="text" class="form-control" id="name_of_test_<?=$i;?>" name="name_of_test_<?=$i;?>" value="<?php echo $order_data['order'][$j]['name_of_test']; ?>" /></td>
                                    <td><input type="text" class="form-control" id="method_of_testing_<?=$i;?>" name="method_of_testing_<?=$i;?>" value="<?php echo $order_data['order'][$j]['mathod_of_test']; ?>" placeholder="Enter Method of Testing"/></td>
                                    <td><input type="text" class="form-control" id="result_<?=$i;?>" name="result_<?=$i;?>" value="<?php echo $order_data['order'][$j]['result']; ?>" placeholder="Results"/></td>
                                    <td><input type="text" class="form-control" id="unit_<?=$i;?>" name="unit_<?=$i;?>" value="<?php echo $order_data['order'][$j]['unit']; ?>" placeholder="Unit" /></td>
                                    <td><input type="text" class="form-control" id="specification_<?=$i;?>" name="specification_<?=$i;?>" value="<?php echo $order_data['order'][$j]['specification']; ?>" placeholder="Specification" /></td>
    			                </tr>
        			            <input type="hidden" value="<?php echo $order_data['order'][$j]['iWaterId']; ?>" id="iWaterId_<?=$i;?>" name="iWaterId_<?=$i;?>"> 
        			          <? } ?>
    			        </tbody>
						</table>
			        </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('water/') ?>" class="btn btn-default">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="approveModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('water/approve') ?>" method="post" id="approveForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="cancelgrModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('water/cancel') ?>" method="post" id="cancelForm">
        <div class="modal-body">
...
function copy()
{
    ...
    window.location.href = '/water/printDiv/'+printid;
}
