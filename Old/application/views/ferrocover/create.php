    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('mainholecover/create') ?>" method="post" class="form-horizontal" id="formsubmitn">
              <div class="box-body">
...
<div class="row uidsection">
                ...
                <div class="row formsection" style="display:none;">
                    ...
                    <div class="col-xs-12" style="margin: 5px 0px;">
                      ...
                      <div class="col-xs-12" style="margin: 5px 0px;">
                      <div class="col-xs-4" >
                          <p>Select Ferro Cover			
                    .</p>
                      </div>
                      <div class="col-xs-8">
                          <select class="form-control" id="ferrocover_sample" name="ferrocover_sample">
                              <option value="">Select Sample</option>
                              <option value="Ferro Cover (01 Set)">Ferro Cover (01 Set)</option>
                              <option value="Ferro Cover (02 Set)">Ferro Cover (02 Set)</option>
                              <option value="Ferro Cover (03 Set)">Ferro Cover (03 Set)</option>
                              <option value="Ferro Cover (04 Set)">Ferro Cover (04 Set)</option>
                              <option value="Ferro Cover (05 Set)">Ferro Cover (05 Set)</option> 
                              <option value="Ferro Cover (06 Set)">Ferro Cover (06 Set)</option>
                              <option value="Ferro Cover (07 Set)">Ferro Cover (07 Set)</option>
                              <option value="Ferro Cover (08 Set)">Ferro Cover (08 Set)</option>
                              <option value="Ferro Cover (09 Set)">Ferro Cover (09 Set)</option>
                              <option value="Ferro Cover (10 Set)">Ferro Cover (10 Set)</option>
                          </select>
                        </div>
                    </div>
			      ...
			      <div class="row formsection" style="display:none;">
                        ...
                        <h5 style="padding:8px;border:1px solid #000;color:#000;text-transform: uppercase;text-align:center;">TEST RESULTS (As per IS : 12592-2002,Ferro Cover)</h5>
                       </div>
                    </div>
			        <div class="row formsection" style="display:none;">
...
<div class="col-xs-12 col-sm-12">
  <table class="table table-striped">
    			        ...
    			        <tr class="set_<?=$i;?>" style="display:none;">
    			            <td colspan ="8">
    			                <select class="form-control" id="cover_type_<?=$i;?>" name="cover_type_<?=$i;?>">
    			                    <option value="Cover FCDC Class A Loading (1000*800)">Cover FCDC Class A Loading (1000*800)</option>
    			                    <option value="Cover FCDC Class A Loading (1500*600)">Cover FCDC Class A Loading (1500*600)</option>
    			                    <option value="Cover FCDC Class A Loading (2100*500)">Cover FCDC Class A Loading (2100*500)</option> 
    			                </select>
    			            </td>
    			        </tr>
        			     <tr class="set_<?=$i;?>" style="display:none;">
        			            <td><?=$i;?></td>
        			            <td><input type="text" class="form-control" id="location_<?=$i;?>" name="location_<?=$i;?>" placeholder="Location"/></td>
                                <td><input type="text" class="form-control" id="dia_of_plat_<?=$i;?>" name="dia_of_plat_<?=$i;?>" placeholder="Dia of Plat"/></td>
                                <td><input type="text" class="form-control" id="date_of_sample_collection_<?=$i;?>" name="date_of_sample_collection_<?=$i;?>" placeholder="Date Of Sample Collection" /></td>
                                <td><input type="text" class="form-control" id="date_of_testing_<?=$i;?>" name="date_of_testing_<?=$i;?>" placeholder="Date Of Testing" /></td>
                                <td><input type="text" class="form-control" id="applying_of_load_<?=$i;?>" name="applying_of_load_<?=$i;?>" placeholder="Applying of Load" /></td>
                                <td>
                                    <select class="form-control" id="observation_<?=$i;?>" name="observation_<?=$i;?>">
    			                        <option value="Crack Not Found">Crack Not Found</option>
    			                        <option value="Crack Found">Crack Found</option>
    			                    </select>
    			                </td>
        			            <td> <input type="text" class="form-control" id="remark_<?=$i;?>" name="remark_<?=$i;?>" placeholder="Enter Remark" /></td>
        			        </tr> 
    			        </tr>
    			        <? } ?>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('mainholecover/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
    ...
    function formsubmit()
    {
      ...
      $("#ferrocover_sample").on('input', function () 
    {
        var val = this.value;
        if(val == 'Ferro Cover (01 Set)')
        {
            $('.set_1').css('display','');    
    ...
    function uidlink_urlno() 
    {
     ...
     $.ajax({
            url:base_url + 'mainholecover/getClientDetails?uid_no='+uid_no,
            type: 'post',
            dataType: 'json',
