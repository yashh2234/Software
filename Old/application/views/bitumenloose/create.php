    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('bitumenloose/create') ?>" method="post" class="form-horizontal" id="formsubmitn">
              <div class="box-body">
               ...
               <div class="row uidsection">
                ...
                <div class="row formsection" style="display:none;">
                    ...
                    <div class="col-xs-12" style="margin: 5px 0px;">
                      <div class="col-xs-4" >
                          <p>Select Bitumenloose Sample			
                    .</p>
                      </div>
                      <div class="col-xs-8">
                          <select class="form-control" id="bitumenloose_sample" name="bitumenloose_sample">
                              <option value="">Select Sample</option>
                              <option value="Bitumenloose Sample (01 Set)">Bitumenloose Sample (01 Set)</option>
                              <option value="Bitumenloose Sample (02 Set)">Bitumenloose Sample (02 Set)</option>
                              <option value="Bitumenloose Sample (03 Set)">Bitumenloose Sample (03 Set)</option>
                              <option value="Bitumenloose Sample (04 Set)">Bitumenloose Sample (04 Set)</option>
                              <option value="Bitumenloose Sample (05 Set)">Bitumenloose Sample (05 Set)</option> 
                              <option value="Bitumenloose Sample (06 Set)">Bitumenloose Sample (06 Set)</option>
                              <option value="Bitumenloose Sample (07 Set)">Bitumenloose Sample (07 Set)</option>
                              <option value="Bitumenloose Sample (08 Set)">Bitumenloose Sample (08 Set)</option>
                              <option value="Bitumenloose Sample (09 Set)">Bitumenloose Sample (09 Set)</option>
                              <option value="Bitumenloose Sample (10 Set)">Bitumenloose Sample (10 Set)</option>
                          </select>
                        </div>
                    </div>
                     <div class="col-xs-12" style="margin: 5px 0px;">
...
<div class="col-xs-12 col-sm-12">
  <table class="table table-striped">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('bitumenloose/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
    ...
    $("#bitumenloose_sample").on('input', function () 
    {
        var val = this.value;
        if(val == 'Bitumenloose Sample (01 Set)')
        {
            $('.set_1').css('display','');    
        ...
        if(val == 'Bitumenloose Sample (02 Set)')
        {
            $('.set_1').css('display','');    
            $('.set_2').css('display','');
            $('.set_3').css('display','none'); 
            ...
            $('.set_10').css('display','none'); 
           $('#countset').val('2');
        }if(val == 'Bitumenloose Sample (03 Set)')
        {
            $('.set_1').css('display','');    
            $('.set_2').css('display','');
            $('.set_3').css('display',''); 
            ...
            $('.set_10').css('display','none'); 
           $('#countset').val('3');
        }if(val == 'Bitumenloose Sample (04 Set)')
        {
            $('.set_1').css('display','');    
            $('.set_2').css('display','');
            $('.set_3').css('display',''); 
            ...
            $('.set_10').css('display','none'); 
           $('#countset').val('4');
        }if(val == 'Bitumenloose Sample (05 Set)')
        {
            $('.set_1').css('display','');    
            $('.set_2').css('display','');
            $('.set_3').css('display',''); 
            ...
            $('.set_10').css('display','none'); 
           $('#countset').val('5');
        }if(val == 'Bitumenloose Sample (06 Set)')
        {
            $('.set_1').css('display','');    
            $('.set_2').css('display','');
            $('.set_3').css('display',''); 
            ...
            $('.set_10').css('display','none'); 
           $('#countset').val('6');
        }if(val == 'Bitumenloose Sample (07 Set)')
        {
            $('.set_1').css('display','');    
            $('.set_2').css('display','');
            $('.set_3').css('display',''); 
            ...
            $('.set_10').css('display','none'); 
           $('#countset').val('7');
        }if(val == 'Bitumenloose Sample (08 Set)')
        {
            $('.set_1').css('display','');    
            $('.set_2').css('display','');
            $('.set_3').css('display',''); 
            ...
            $('.set_10').css('display','none'); 
           $('#countset').val('8');
        }if(val == 'Bitumenloose Sample (09 Set)')
        {
            $('.set_1').css('display','');    
            $('.set_2').css('display','');
            $('.set_3').css('display',''); 
            ...
            $('.set_10').css('display','none'); 
           $('#countset').val('9');
        }if(val == 'Bitumenloose Sample (10 Set)')
        {
            $('.set_1').css('display','');    
            $('.set_2').css('display','');
            $('.set_3').css('display',''); 
