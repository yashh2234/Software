                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Registration</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createRegistration" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateRegistration" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewRegistration" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteRegistration" class="minimal"></td>
                      </tr>
                      <tr>
                        <td>Lab Reports</td>
                      ...
                      <tr>
                        <td>Vehicle</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createVehicle" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateVehicle" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewVehicle" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteVehicle" class="minimal"></td>
                      </tr>
                      <tr>
                        <td>Drivers</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createDriver" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateDriver" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewDriver" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteDriver" class="minimal"></td>
                      </tr>
                      <tr>
                        <td>Category</td>
