                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                          <tr>
                        <td>Registration</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createRegistration" <?php if($serialize_permission) {
                          if(in_array('createRegistration', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateRegistration" <?php if($serialize_permission) {
                          if(in_array('updateRegistration', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewRegistration" <?php if($serialize_permission) {
                          if(in_array('viewRegistration', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteRegistration" <?php if($serialize_permission) {
                          if(in_array('deleteRegistration', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <!--
                      <tr>
                      ...
                      <tr>
                        <td>Laser</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createLaser" <?php if($serialize_permission) {
                          if(in_array('createLaser', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateLaser" <?php if($serialize_permission) {
                          if(in_array('updateLaser', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewLaser" <?php if($serialize_permission) {
                          if(in_array('viewLaser', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteLaser" <?php if($serialize_permission) {
                          if(in_array('deleteLaser', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                        <tr>
                        <td>Vehicle</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createVehicle" <?php if($serialize_permission) {
                          if(in_array('createVehicle', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateVehicle" <?php if($serialize_permission) {
                          if(in_array('updateVehicle', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewVehicle" <?php if($serialize_permission) {
                          if(in_array('viewVehicle', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteVehicle" <?php if($serialize_permission) {
                          if(in_array('deleteVehicle', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      
                        <tr>
                        <td>Drivers</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createDriver" <?php if($serialize_permission) {
                          if(in_array('createDriver', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateDriver" <?php if($serialize_permission) {
                          if(in_array('updateDriver', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewDriver" <?php if($serialize_permission) {
                          if(in_array('viewDriver', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteDriver" <?php if($serialize_permission) {
                          if(in_array('deleteDriver', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      
                       <tr>
                        <td>Consignee</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createConsignee" <?php if($serialize_permission) {
                          if(in_array('createConsignee', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateConsignee" <?php if($serialize_permission) {
                          if(in_array('updateConsignee', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewConsignee" <?php if($serialize_permission) {
                          if(in_array('viewConsignee', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteConsignee" <?php if($serialize_permission) {
                          if(in_array('deleteConsignee', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      
                       <tr>
                        <td>Consignor</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createConsignor" <?php if($serialize_permission) {
                          if(in_array('createConsignor', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateConsignor" <?php if($serialize_permission) {
                          if(in_array('updateConsignor', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewConsignor" <?php if($serialize_permission) {
                          if(in_array('viewConsignor', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteConsignor" <?php if($serialize_permission) {
                          if(in_array('deleteConsignor', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
