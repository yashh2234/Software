...
<div class="content-wrapper">
  ...
  <?php if(!empty($order_data['order'][0]['ulr_no'])){?>
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('sand/update') ?>" method="post" class="form-horizontal" id="formsubmitn">
              <div class="box-body">
...
<div class="row">
    ...
    <div class="row">
			       ...
			       <div class="row">
                        ...
                        <h5 style="padding:8px;background-color:#000 !important;color:#fff !important;text-transform: uppercase;text-align:center;">Gradation of Fine Aggregate ( As per IS 383-2016)</h5>
                       </div>
                    </div>
                    <div class="col-xs-12 col-sm-12">
   <div class="col-xs-12 col-sm-12">
   <table class="table table-striped">
    			        ...
    			        for($i=0;$i<$countset;$i++){ ?>
    			          <tr>
    			             ...
    			             ?>
    			               ...
    			               <input type="hidden" value="<?php echo $order_data['order'][$i]['iSandId'];?>" id="iSandId_<?=$j;?>" name="iSandId_<?=$j;?>">
    			             
    			             <td style="border:1px solid #000;color:#000;text-transform: uppercase;"><input type="text" class="form-control" id="is_sieve_size_<?=$j;?>" name="is_sieve_size_<?=$j;?>" value="<?php echo $order_data['order'][$i]['is_sieve_size'];?>" /></td>
    			            <td style="border:1px solid #000;color:#000;text-transform: uppercase;"><input type="text" class="form-control" id="weight_retained_in_gm_<?=$j;?>" name="weight_retained_in_gm_<?=$j;?>"  value="<?php echo $order_data['order'][$i]['weight_retained_in_gm'];?>" /></td>
    			            <td style="border:1px solid #000;color:#000;text-transform: uppercase;"><input type="text" class="form-control" id="weight_retained_in_perc_<?=$j;?>" name="weight_retained_in_perc_<?=$j;?>" value="<?php echo $order_data['order'][$i]['weight_retained_in_perc'];?>"  /></td>
    			            <td style="border:1px solid #000;color:#000;text-transform: uppercase;"><input type="text" class="form-control" id="cum_weight_retained_in_perc_<?=$j;?>" name="cum_weight_retained_in_perc_<?=$j;?>" value="<?php echo $order_data['order'][$i]['cum_weight_retained_in_perc'];?>" /></td>
                            <td style="border:1px solid #000;color:#000;text-transform: uppercase;"><input type="text" class="form-control" id="passing_<?=$j;?>" name="passing_<?=$j;?>" value="<?php echo $order_data['order'][$i]['passing'];?>" /></td>
                            <td style="border:1px solid #000;color:#000;text-transform: uppercase;"><input type="text" class="form-control" id="is_grading_as_per_is_<?=$j;?>" name="is_grading_as_per_is_<?=$j;?>" value="<?php echo $order_data['order'][$i]['is_grading_as_per_is'];?>"  /></td>
                             <?
    			             if($i == 0)
        			            {
        			             ?>
        			              <td rowspan="7" style="border:1px solid #000;color:#000;text-transform: uppercase;"><input type="text" class="form-control" id="remarks" name="remarks" value="<?php echo $order_data['order'][$i]['remarks'];?>" /></td>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('sand/') ?>" class="btn btn-default">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="approveModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('sand/approve') ?>" method="post" id="approveForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="cancelgrModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('sand/cancel') ?>" method="post" id="cancelForm">
        <div class="modal-body">
...
function copy()
{
    ...
    window.location.href = '/sand/printDiv/'+printid;
}
