...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Manage
      <small>Sand Report</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Sand Report</li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createOrder', $user_permission)): ?>
          <a href="<?php echo base_url('Sand/create') ?>" class="btn btn-primary">Create Report</a>
        <?php endif; ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Sand/remove') ?>" method="post" id="removeForm">
...
$(document).ready(function() 
{
  ...
  $("#manageOrdersNav").addClass('active');
    ...
    if(start_date)
    {
        ...
        'ajax': base_url + 'sand/fetchOrdersFilterData?start_date='+start_date+'&end_date='+end_date,
        scrollX: true,
        'order': []
    ...
    else
    {
         // initialize the datatable 
        manageTable = $('#manageTable').DataTable({
        'ajax': base_url + 'sand/fetchOrdersData',
        scrollX: true,
        'order': []
        });
