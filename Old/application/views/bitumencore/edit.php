...
<div class="content-wrapper">
  ...
  <?php if(!empty($order_data['order'][0]['ulr_no'])){?>
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('bitumencore/update') ?>" method="post" class="form-horizontal" id="formsubmitn">
              <div class="box-body">
...
<div class="modal fade" tabindex="-1" role="dialog" id="approveModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('bitumencore/approve') ?>" method="post" id="approveForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="cancelgrModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('bitumencore/cancel') ?>" method="post" id="cancelForm">
        <div class="modal-body">
